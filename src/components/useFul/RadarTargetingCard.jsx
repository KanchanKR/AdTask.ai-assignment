...
const RadarTargetingCard = () => {
  const startPositions = [
    ...
    { x: 140 * Math.cos((3 * Math.PI) / 4), y: 140 * Math.sin((3 * Math.PI) / 4) }, // Top Left
    { x: 140 * Math.cos((5 * Math.PI) / 4), y: 140 * Math.sin((5 * Math.PI) / 4) }, // Bottom Left
    { x: 140 * Math.cos((7 * Math.PI) / 4), y: 140 * Math.sin((7 * Math.PI) / 4) }, // Bottom Right
  ];
